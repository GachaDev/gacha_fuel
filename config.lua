Config = {}
Config.PriceLitre = 1 --Price per litre
...
Config.ProgressTime = 8 --seconds

-- Configure the strings as you wish here.
Config.Strings = {
	ExitVehicle = "Get out of the vehicle to refuel",
	EToRefuel = "Press ~y~E~w~ to refuel",
	FullTank = "Full tank",
	NoMoney = "You dont have enough money",
	Cancel = 'You cancel the action',
	Total = 'TOTAL',
	Title = 'GAS STATION',
